...
.explode {
  background:url(/www.myshop.com/Public/Admin/Images/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(/www.myshop.com/Public/Admin/Images/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(/www.myshop.com/Public/Admin/Images/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/www.myshop.com/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            商品管理
                <ul>
                    <li class="menu-item"><a href="/www.myshop.com/index.php/Admin/Goods/lst.html" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="/www.myshop.com/index.php/Admin/Goods/add.html" target="main-frame">添加新商品</a></li>
                    <li class="menu-item"><a href="/www.myshop.com/index.php/Admin/Category/lst.html" target="main-frame">商品分类</a></li>
                    <li class="menu-item"><a href="/www.myshop.com/index.php/Admin/Brand/lst.html" target="main-frame">商品品牌</a></li>
...
<script type="text/javascript" src="/www.myshop.com/Public/Admin/Js/global.js"></script>
<script type="text/javascript" src="/www.myshop.com/Public/Admin/Js/utils.js"></script>
<script type="text/javascript" src="/www.myshop.com/Public/Admin/Js/transport.js"></script>
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/www.myshop.com/Public/Admin/Images/menu_minus.gif' : '/www.myshop.com/Public/Admin/Images/menu_plus.gif';
